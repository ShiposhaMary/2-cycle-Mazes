...
namespace Mazes
{
    internal static class Program
    {
        ...
        {
            yield return new MazeTestCase("empty1", My_EmptyMazeTask.MoveOut);
            yield return new MazeTestCase("empty2", My_EmptyMazeTask.MoveOut);
            yield return new MazeTestCase("empty3", My_EmptyMazeTask.MoveOut);
            yield return new MazeTestCase("empty4", My_EmptyMazeTask.MoveOut);
            yield return new MazeTestCase("empty5", My_EmptyMazeTask.MoveOut);
            
            yield return new MazeTestCase("snake1", My_SnakeMazeTask.MoveOut);
            yield return new MazeTestCase("snake2", My_SnakeMazeTask.MoveOut);
            yield return new MazeTestCase("snake3", My_SnakeMazeTask.MoveOut);
            ...
            */yield return new MazeTestCase("diagonal1", My_DiagonalMazeTask.MoveOut);
            yield return new MazeTestCase("diagonal2", My_DiagonalMazeTask.MoveOut);
            yield return new MazeTestCase("diagonal3", My_DiagonalMazeTask.MoveOut);
